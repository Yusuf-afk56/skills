      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-60px" }}
            variants={{ hidden: fadeUp.hidden, visible: { opacity: 1, y: 0, transition: { duration: 0.55, delay: 0.1, ease: [0.22, 0.68, 0, 1.2] as const } } }}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {expertiseAreas.map(({ icon: Icon, title, description }, i) => (
            <motion.div
              ...
              variants={{
                hidden: { opacity: 0, y: 24 },
                visible: { opacity: 1, y: 0, transition: { duration: 0.5, delay: i * 0.06, ease: [0.22, 0.68, 0, 1.2] as const } },
              }}
    ...
    <section id="services" className="py-24" style={{ background: `linear-gradient(160deg, ${navy} 0%, ${navyMid} 100%)` }}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {services.map(({ title, items }, i) => (
            <motion.div
              ...
              variants={{
                hidden: { opacity: 0, y: 24 },
                visible: { opacity: 1, y: 0, transition: { duration: 0.5, delay: i * 0.08, ease: [0.22, 0.68, 0, 1.2] as const } },
              }}
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-40px" }}
          variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.3, ease: [0.22, 0.68, 0, 1.2] as const } } }}
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-60px" }}
            variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.55, delay: 0.1, ease: [0.22, 0.68, 0, 1.2] as const } } }}
          >
            <ContactForm />
          </motion.div>
        </div>
